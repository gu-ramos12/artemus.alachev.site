...
export function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/xvzbgzqp", {
        method: "POST",
        headers: {
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Gestão de Cultura Organizacional">Gestão de Cultura Organizacional</option>
                  <option value="Liderança Transformacional">Liderança Transformacional</option>
                  <option value="Promova-se em 6 Meses">Promova-se em 6 Meses</option>
                  <option value="Universidade Corporativa">Universidade Corporativa</option>
              ...
              <button
                ...
                className="w-full px-6 sm:px-8 py-3 sm:py-4 rounded-lg transition-opacity hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed"
                style={{
